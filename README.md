About robotframework-lint-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-lint-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4297&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-lint-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-lint` can be installed with `conda`:
...
```
mamba install robotframework-lint
```

It is possible to list all of the versions of `robotframework-lint` available on your platform with `conda`:
...
```
mamba search robotframework-lint --channel conda-forge
```
...
mamba repoquery search robotframework-lint --channel conda-forge

# List packages depending on `robotframework-lint`:
mamba repoquery whoneeds robotframework-lint --channel conda-forge

# List dependencies of `robotframework-lint`:
mamba repoquery depends robotframework-lint --channel conda-forge
```
